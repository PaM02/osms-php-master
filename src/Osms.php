...
class Osms
{
     ...
     * @var string
     */
    protected $clientId = 'tAV28VlYxd5i5ZcLx3mPMzlHN7TWAWYL';
     ...
     * @var string
     */
    protected $clientSecret = 'PYFUGHDxITzb2n05';
    ...
    {   
        ...
        $headers = array('Authorization: Basic ' . base64_encode($credentials),"Accept: application/json");
